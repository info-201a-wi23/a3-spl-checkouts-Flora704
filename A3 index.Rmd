...
For the last chart, I have a bar chart to see what  the books that the number of checkouts is over 80 are in 2022. By plotting seven book titles that have had more than 80 checkouts, I was able to make a bar chart to see how the books are distributed. From the bar chart, it seems there are three ‘1984’, another three ‘Animal Farm’, and one ‘Orwell's roses’. Total seven books are there and the most checkouts among these are from ‘1984’. 
